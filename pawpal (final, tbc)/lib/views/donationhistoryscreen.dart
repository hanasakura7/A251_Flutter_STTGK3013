  ...
  Future<void> _loadMyDonations() async {
    try {
      final response = await http.get(
        Uri.parse(
          "${MyConfig.baseUrl}/pawpal/api/get_user_donations.php?userid=${widget.user.userId}",
        ),
      );
                  ...
                  child: ListTile(
                    ...
                    trailing: Text(
                      (donation['donation_date'] != null &&
                              donation['donation_date'].toString().length >= 10)
                          ? donation['donation_date'].toString().substring(0, 10)
                          : "N/A",
